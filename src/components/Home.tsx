  ...
  return (
    <div id='Home' className="flex flex-col-reverse md:flex-row justify-center items-center md:my-32 my-10">
        <div className='flex flex-col'>
            ...
            <p className="my-4 text-md text-center md:text-left">Je suis un developpeur FRONT-END Junior,<br /> utilisant React,TailWindCSS.<br />Contactez-moi si vous avez besoin de mes services.</p>
